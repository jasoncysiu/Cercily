    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <h4 className="font-semibold">Interactive Decision Map</h4>
      ...
      <div
        ref={canvasRef}
        className={`relative w-full bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg overflow-hidden touch-none ${
      ...
      >
        ...
        {items.map((item) => (
          <div
            key={item.id}
            className={`absolute transition-shadow hover:shadow-lg ${item.color} border-2 rounded-lg p-2 md:p-3 min-w-[160px] md:min-w-[180px] max-w-[180px] md:max-w-[200px] ${
