    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
      ...
      <Card className="p-5">
        <div className="text-center mb-3">
          <h3 className="text-base font-semibold text-blue-600 mb-1">{safeAnalysis.option1.title}</h3>
      ...
      <Card className="p-5">
        <div className="text-center mb-3">
          <h3 className="text-base font-semibold text-orange-600 mb-1">{safeAnalysis.option2.title}</h3>
