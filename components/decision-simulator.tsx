    ...
    <Card className="p-5">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          <h4 className="font-semibold text-base">Adjust Your Parameters</h4>
        ...
        {/* Results */}
        <div className="space-y-3">
          <h4 className="font-semibold text-base">Simulation Results</h4>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-sm">{safeSimulator.option1Title}</div>
                  <div className="text-xs text-gray-600">{safeSimulator.parameters[0]?.impact}</div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-medium text-sm">{safeSimulator.option2Title}</div>
                  <div className="text-xs text-gray-600">{safeSimulator.parameters[1]?.impact}</div>
                </div>
              </div>
